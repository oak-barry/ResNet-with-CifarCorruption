...
def parse_args():
    parser = argparse.ArgumentParser(description='PyTorch CIFAR10C Co-Testing')
    # Experiment setting
...
def show_performance(distortion_name):
    PATH = "./dataset/CIFAR-10-C/" + distortion_name + ".npy"
    ...
    source_label = np.load("./dataset/CIFAR-10-C/labels.npy")
    ...
    err = 1 - correct / len(testset.dataset)
...
if __name__ == '__main__':
    ...
    for distortion_name in distortions:
        ...
        print('Distortion: {:15s}  | CE(%): {:.2f}'.format(distortion_name, 100 * rate))
        print()
